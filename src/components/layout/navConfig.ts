  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        badge: '20',
        children: [
          { id: 'comp-kyb', label: 'Supplier KYB', path: '/compliance/kyb' },
          { id: 'comp-kyc', label: 'Individual KYC', path: '/compliance/kyc' },
          { id: 'comp-sanctions', label: 'Sanctions Screening', path: '/compliance/sanctions' },
          { id: 'comp-aml', label: 'AML Monitoring', path: '/compliance/aml' },
          { id: 'comp-risk-supplier', label: 'Supplier Risk Scoring', path: '/compliance/risk-supplier' },
          { id: 'comp-risk-guest', label: 'Guest Risk Scoring', path: '/compliance/risk-guest' },
          { id: 'comp-insurance', label: 'Insurance & Underwriting', path: '/compliance/insurance' },
          { id: 'comp-claims', label: 'Claims Processing', path: '/compliance/claims' },
          { id: 'comp-sanctions-feed', label: 'Sanctions List Feed', path: '/compliance/sanctions-feed' },
          { id: 'comp-disputes', label: 'Dispute Arbitration', path: '/compliance/disputes' },
          { id: 'comp-bonding', label: 'Bonding & Licensing', path: '/compliance/bonding' },
          { id: 'comp-consumer', label: 'Consumer Protection Rules', path: '/compliance/consumer' },
          { id: 'comp-privacy', label: 'Privacy Law Compliance', path: '/compliance/privacy' },
          { id: 'comp-dsar', label: 'DSAR Fulfillment', path: '/compliance/dsar' },
          { id: 'comp-tos', label: 'Terms & Policy Versions', path: '/compliance/tos' },
          { id: 'comp-consent', label: 'Consent Ledger', path: '/compliance/consent' },
          { id: 'comp-fraud', label: 'Fraud Investigation', path: '/compliance/fraud' },
          { id: 'comp-chargebacks', label: 'Chargeback Network', path: '/compliance/chargebacks' },
          { id: 'comp-sar', label: 'SAR Filing', path: '/compliance/sar' },
          { id: 'comp-audit', label: 'Audit Evidence Repository', path: '/compliance/audit' },
        ],
      },
      {
        id: 'support',
